...
class Book(Base):
    ...
    hub_work_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    ...
    translator_role: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    source_hub_work_id: Mapped[str] = mapped_column(String(120), nullable=False, default="")
