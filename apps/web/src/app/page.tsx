      ...
      <section className="fade-up relative overflow-hidden pb-10 pt-4 sm:pb-14 sm:pt-8">
        ...
        <div className="mt-4 flex items-center gap-4 sm:gap-5">
          ...
          <img
            ...
            alt=""
            className="h-16 w-16 rounded-2xl object-cover shadow-[var(--shadow)] sm:h-20 sm:w-20"
          />
          <h1 className="brand-mark max-w-3xl text-5xl font-semibold leading-[0.95] text-[var(--ink)] sm:text-7xl">
            Read
          </h1>
        </div>
